...
@XmlRootElement(name = "promotionRequest")
public class PromotionRequest {

    @XmlElementRefs({
        @XmlElementRef(name = "productCode", namespace = "http://cloud.cit.ie/promotion", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "productDiscount", namespace = "http://cloud.cit.ie/promotion", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "productQuantity", namespace = "http://cloud.cit.ie/promotion", type = JAXBElement.class, required = false)
    })
