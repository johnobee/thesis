...
public class VoucherRequest {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "productDiscount", namespace = "http://cloud.cit.ie/voucher", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "productQuantity", namespace = "http://cloud.cit.ie/voucher", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "productCode", namespace = "http://cloud.cit.ie/voucher", type = JAXBElement.class, required = false)
    })
