...
public class CreditcardRequest {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "productQuantity", namespace = "http://cloud.cit.ie/creditcard", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "productCode", namespace = "http://cloud.cit.ie/creditcard", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "productDiscount", namespace = "http://cloud.cit.ie/creditcard", type = JAXBElement.class, required = false)
    })
